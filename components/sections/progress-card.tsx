  ...
  return (
    <Card>
      <div className="flex items-end justify-between gap-3">
        <div>
          <p className="text-xs uppercase tracking-wide text-secondaryText">Progress to next level</p>
          <p className="mt-2 text-xl font-semibold">{target ? formatKRW(target) : "Top level reached"}</p>
        </div>
        <span className="text-sm text-secondaryText">{formatPercent(progress)}</span>
      </div>
